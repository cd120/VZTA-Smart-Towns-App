...
//        String sql = "INSERT INTO user_table (username, enabled, email, address, address2, city, zipCode) VALUES (?, ?, ?, ? ,?,?,?,?) RETURNING username";
//        String username = jdbc.queryForObject(sql, String.class, profile.getUserName(), profile.getEmail(), profile.getAddress(), profile.getAddress2(), profile.getCity(),profile.getZipCode());
